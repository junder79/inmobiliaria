            ...
            <tbody style="background-color:#f5f5f5">
                ...
                while ($filas = mysqli_fetch_array($getInmuebles)) {  ?>
                    <tr class="shadow-sm bg-white rounded">
                        ...
                        <td><a target="_blank" href="http://grupohexxa.cl/inmobiliariaAPP/tcpdf/examples/informe.php?idInmueble=<?php echo $filas['idInmueble'] ?>"><button type="button" class="btn-danger btn btn-sm" id="<?php echo $filas['idInmueble'] ?>" ><i class="fas fa-file-pdf"></i></button></a></td>
